...
The “package.json” file is used by the “npm” terminal command which stands for Node Package Manager.  This command lets us manage the libraries we have installed as well as install new ones.  To create a package.json file, run the command in the terminal “npm init” in the root of our project directory.
